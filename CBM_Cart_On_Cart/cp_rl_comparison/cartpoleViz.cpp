...
const SDL_Rect CartPoleViz::blue_back = {212,148,60,58};
const SDL_Rect CartPoleViz::blue_reverse = {74,148,60,58};
const SDL_Rect CartPoleViz::blue_play = {106,50,60,58};
const SDL_Rect CartPoleViz::blue_pause = {177,50,60,58};
const SDL_Rect CartPoleViz::blue_ff   = {142,148,60,58};
const SDL_Rect CartPoleViz::blue_next = {279,148,60,58};

const SDL_Rect CartPoleViz::purple_reverse = {360,148,60,58};
const SDL_Rect CartPoleViz::purple_back = {497,148,60,58};
const SDL_Rect CartPoleViz::purple_ff = {428,148,60,58};
const SDL_Rect CartPoleViz::purple_next = {565,148,60,58};
const SDL_Rect CartPoleViz::purple_play = {391,50,60,58};
const SDL_Rect CartPoleViz::purple_pause = {463,50,60,58};

const SDL_Rect CartPoleViz::speedup = {230,283,65,65};
const SDL_Rect CartPoleViz::slowdown = {160,283,65,65};
...
CartPoleViz::CartPoleViz(float _tracklen, float _polelen, float _leftAngBound, float _rightAngBound,
    ...
    speedupButton(405,340,60,58,&speedup,&speedup)
{
    ...
    pthread_create(&thread, NULL, &CartPoleViz::thread_helper, this);
};

CartPoleViz::~CartPoleViz() {
...
SDL_Surface* CartPoleViz::load_image( std::string filename )
{
...
void CartPoleViz::drawCartpole(float cartpos, float cartvel, float poleang, float polevel,
                               ...
                               int timeAloft, int trialNum, int cycle, int playspeed) {
...
void CartPoleViz::drawText(string s, SDL_Rect& dest) {
