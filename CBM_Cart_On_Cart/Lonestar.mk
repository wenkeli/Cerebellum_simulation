...
CUDAINCPATH = '/opt/apps/cuda/4.2/cuda/include/'
CUDALIBPATH = '/opt/apps/cuda/4.2/cuda/lib64/'
CUDALIBS = -lcuda 
#-lcudart

QTINCPATH = '/opt/apps/qt/4.7.0/include/'
...
EXTMINC = $(EXTMIP)/cartpole.h $(EXTMIP)/externaldummy.h $(EXTMIP)/externalbase.h
...
EXTMSRC = $(EXTMSP)/externalbase.cpp $(EXTMSP)/cartpole.cpp $(EXTMSP)/externaldummy.cpp
...
EXTMOBJ = $(OUTPATH)/externalbase.obj $(OUTPATH)/cartpole.obj $(OUTPATH)/externaldummy.obj
...
benchapp: benchmain bench core
	-$(NVCC) $(BENCHAPPOBJ) -o $(OUTPATH)/$(NAME)bench -L$(CUDALIBPATH) -L$(QTLIBPATH) -L$(INTELLIBPATH) $(QTLIBS) $(SDLLIBS) $(CUDALIBS) $(INTELLIBS)
