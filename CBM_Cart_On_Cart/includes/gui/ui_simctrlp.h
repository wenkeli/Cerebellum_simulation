...
public:
    ...
    void setupUi(QWidget *SimCtrlPClass)
    {
        ...
        verticalLayoutWidget_2->setGeometry(QRect(30, 70, 191, 171));
        ...
        formLayoutWidget_2 = new QWidget(SimCtrlPClass);
        formLayoutWidget_2->setObjectName(QString::fromUtf8("formLayoutWidget_2"));
        formLayoutWidget_2->setGeometry(QRect(30, 30, 191, 31));
        formLayout_2 = new QFormLayout(formLayoutWidget_2);
        formLayout_2->setSpacing(6);
        formLayout_2->setContentsMargins(11, 11, 11, 11);
        formLayout_2->setObjectName(QString::fromUtf8("formLayout_2"));
        formLayout_2->setContentsMargins(0, 0, 0, 0);
        mZNumBox = new QSpinBox(formLayoutWidget_2);
        mZNumBox->setObjectName(QString::fromUtf8("mZNumBox"));

        formLayout_2->setWidget(0, QFormLayout::LabelRole, mZNumBox);
        ...
        QObject::connect(mZNumBox, SIGNAL(valueChanged(int)), SimCtrlPClass, SLOT(changeMZDispNum(int)));
    ...
    void retranslateUi(QWidget *SimCtrlPClass)
    {
        ...
        label->setText(QApplication::translate("SimCtrlPClass", "Micro Zone number", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
