...
static const char qt_meta_stringdata_SimThread[] = {
    ...
    "updateBlankDisp()\0"
    "updateActW(vector<unsigned char>,vector<bool>)\0"
};
...
int SimThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: updateActW((*reinterpret_cast< vector<unsigned char>(*)>(_a[1])),(*reinterpret_cast< vector<bool>(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 8;
    }
...
// SIGNAL 7
void SimThread::updateActW(vector<unsigned char> _t1, vector<bool> _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
