...
//	}
	...
	//mossy fibers
	numMF=1<<paramMap["numMFP2"];
	numpMFfromMFtoGL=numGL/numMF;
	maxnumpMFfromMFtoGO=numpMFfromMFtoGL*maxnumpGLfromGLtoGO;
	maxnumpMFfromMFtoGR=numpMFfromMFtoGL*maxnumpGLfromGLtoGR;
...
void ConnectivityParams::showParams(ostream &outSt)
{
	...
	outSt<<"numpMFfromMFtoGL "<<numpMFfromMFtoGL<<endl;
